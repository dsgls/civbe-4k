...
local Tutorials = {	
	{
		...
		Map = "Tutorials/Maps/Tutorial_1_MovementAndExploration.CivBEMap",	
	},
	
	{
		...
		Map = "Tutorials/Maps/Tutorial_2_FoundCities.CivBEMap",
	},
	
	{
		...
		Map = "Tutorials/Maps/Tutorial_3_ImprovingCities.CivBEMap",
	},
	
	{
		...
		Map = "Tutorials/Maps/Tutorial_4_CombatAndConquest.CivBEMap",
	},
	
	{
		...
		Map = "Tutorials/Maps/Tutorial_5_Diplomacy.CivBEMap",
	}
}
...
function OnStart()
	...
	if (g_iSelected == -1) then
		PreGame.SetMapScript("Assets\\Maps\\Protean.lua");
