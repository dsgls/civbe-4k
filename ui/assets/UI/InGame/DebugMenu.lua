...
-------------------------------------------------
-- Toggle Show UI scratch box
-------------------------------------------------
function ToggleUIScratchBoxes()
    bUIScratchBoxes = not bUIScratchBoxes;
	Controls.ToggleUIScratchBoxes_Checkbox:SetCheck( bUIScratchBoxes );
	UIManager:SetDrawControlBounds( bUIScratchBoxes );
end
Controls.ToggleUIScratchBoxes_Checkbox:RegisterCallback( Mouse.eLClick, ToggleUIScratchBoxes );
Controls.ToggleUIScratchBoxes_Button:RegisterCallback( Mouse.eLClick, ToggleUIScratchBoxes );
bUIScratchBoxes = false;
...
function ToggleCityBanners()
	...
	ContextPtr:LookUpControl( "/InGame/WorldViewControls/CityBannerManager" ):SetHide( not bCityBanners );
end
...
function ToggleUnitFlags()
	...
	ContextPtr:LookUpControl( "/InGame/WorldViewControls/UnitFlagManager" ):SetHide( not bUnitFlags );
end
...
function InputHandler( uiMsg, wParam, lParam )
    ...
    return UI.DebugKeyHandler( uiMsg, wParam, lParam );
end
