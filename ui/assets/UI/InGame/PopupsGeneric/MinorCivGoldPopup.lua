...
PopupLayouts[ButtonPopupTypes.BUTTONPOPUP_MINOR_GOLD] = function(popupInfo)
	...
	if (iNumGoldPlayerHas >= iLowestGold) then
		popupText = Locale.ConvertTextKey("TXT_KEY_POPUP_MINOR_ENERGY_GIFT", pPlayer:GetCivilizationShortDescriptionKey());	
		SetPopupText(popupText);
	else
		popupText = Locale.ConvertTextKey("TXT_KEY_POPUP_MINOR_ENERGY_GIFT_CANT", iLowestGold, pPlayer:GetCivilizationShortDescriptionKey());	
		SetPopupText(popupText);
	end
