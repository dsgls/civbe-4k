...
function OnWarButtonClicked ()
	UI.AddPopup{ Type = ButtonPopupTypes.BUTTONPOPUP_DECLAREWARMOVE, Data1 = g_iMinorCivID, Option1 = true};
end
...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
local iGoldGiftLarge = GameDefines["MINOR_ENERGY_GIFT_LARGE"];
local iGoldGiftMedium = GameDefines["MINOR_ENERGY_GIFT_MEDIUM"];
local iGoldGiftSmall = GameDefines["MINOR_ENERGY_GIFT_SMALL"];
...
function PopulateGiftChoices()	
	...
	-- Small Energy
	local iNumGoldPlayerHas = pActivePlayer:GetEnergy();
	
	iGold = iGoldGiftSmall;
	iLowestGold = iGold;
	iFriendshipAmount = pPlayer:GetFriendshipFromGoldGift(iActivePlayer, iGold);
	local buttonText = Locale.ConvertTextKey("TXT_KEY_POPUP_MINOR_ENERGY_GIFT_AMOUNT", iGold, iFriendshipAmount);
	...
	local strInfoTT = Locale.ConvertTextKey("TXT_KEY_POP_CSTATE_ENERGY_STATUS_TT", iFriendsAmount, iAlliesAmount, iFriendship);
	strInfoTT = strInfoTT .. "[NEWLINE][NEWLINE]";
	strInfoTT = strInfoTT .. Locale.ConvertTextKey("TXT_KEY_POP_CSTATE_ENERGY_TT");
...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
local iBullyGoldInfluenceLost = (GameDefines["MINOR_FRIENDSHIP_DROP_BULLY_ENERGY_SUCCESS"] / 100) * -1; -- Since XML value is times 100 for fidelity, and negative
...
function PopulateTakeChoices()	
	...
	buttonText = Locale.Lookup("TXT_KEY_POPUP_MINOR_BULLY_ENERGY_AMOUNT", iBullyGold, iBullyGoldInfluenceLost);
