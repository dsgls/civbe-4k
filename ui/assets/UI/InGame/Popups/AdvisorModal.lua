...
function OnPopup( popupInfo )
	...
	Controls.PlayerTitleLabel:SetText(Locale.ConvertTextKey("{TXT_KEY_ADVISOR_MODAL_TITLE:upper}"));    
    ...
    if (imgCtrl) then	
		-- WRM: Hook this back up when we have advisor art.
	--	imgCtrl:SetHide(true);    
    end
