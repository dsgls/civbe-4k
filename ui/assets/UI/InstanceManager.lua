...
InstanceManager = 
{
    ...
    -------------------------------------------------
    RunProcess = function(self, process, available)
		if self.m_AllocatedInstances ~= nil
		then
			for i, instance in ipairs(self.m_AllocatedInstances)
			do
				process(instance);
			end
		end
		...
		if available == true then
			if self.m_AvailableInstances ~= nil
			then
				for i, instance in ipairs(self.m_AvailableInstances)
				do
					process(instance);
				end
			end
