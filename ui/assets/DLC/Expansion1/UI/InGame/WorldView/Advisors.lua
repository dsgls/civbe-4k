...
-- ===========================================================================
--	Special case, game over screen is showing
-- ===========================================================================
...
LuaEvents.GameOverShown.Add(OnGameOverShown);

-- ===========================================================================
--	Special case, game over screen is hidden
-- ===========================================================================
function OnGameOverHidden()
	if ( m_bIsOpen ) then
		ContextPtr:SetHide( false );
	end
end
LuaEvents.GameOverHidden.Add(OnGameOverHidden);
...
function OnHidingOtherPopup( popupID )
	if ( popupID == ButtonPopupTypes.BUTTONPOPUP_TUTORIAL or
		 ...
		 popupID == ButtonPopupTypes.BUTTONPOPUP_AFFINITY_OVERVIEW) 
	then
		if ( m_bIsOpen ) then
			ContextPtr:SetHide( false );
		end
